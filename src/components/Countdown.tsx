...
export default function Countdown({ targetDate }: CountdownProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <p className="text-sm text-[#7C3AED] font-semibold tracking-wider font-[family-name:var(--font-heebo)]">
        ההטבה נגמרת בעוד
      </p>
        ...
        {blocks.map((block) => (
          <div key={block.label} className="flex flex-col items-center">
            <motion.div
              ...
              className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-b from-[#1A1525] to-[#15111F] border border-white/10 rounded-xl flex items-center justify-center"
            >
              <div className="absolute top-0 left-2 right-2 h-[2px] bg-gradient-to-r from-transparent via-[#7C3AED] to-transparent" />
