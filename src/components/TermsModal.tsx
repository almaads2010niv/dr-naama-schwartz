  ...
  return (
    <>
      <button
        ...
        className="text-gray-500 hover:text-[#2E9ED8] underline underline-offset-4 transition-colors cursor-pointer text-sm"
      >
        תנאי השירות
      </button>
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-[#FFFFFF] border border-gray-200 rounded-3xl p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto z-10"
            >
              <button
                onClick={() => setOpen(false)}
                className="absolute top-4 left-4 w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:text-[#003D68] transition-all cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>

              <h2 className="font-[family-name:var(--font-heebo)] font-black text-2xl text-[#003D68] mb-6">
              ...
              <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
                <div>
                  <h4 className="text-[#003D68] font-bold mb-2">1. מהות השירות</h4>
