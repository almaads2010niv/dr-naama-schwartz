          ...
          <div className="relative bg-[#7C3AED] rounded-[32px] p-10 sm:p-14 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="text-white/90 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed mb-8 space-y-5">
                <p>
                  ייעוץ טלפוני של 10 דקות — חינם, בלי התחייבות, בלי לחץ.
                  ד״ר נעמה אישית על הקו, עם 20+ שנות ניסיון בטיפול בכאב.
                </p>

                <p>
                  אם אחרי השיחה תחליטו שזה לא בשבילכם —{" "}
                  <strong>זה בסדר גמור.</strong>
                </p>
